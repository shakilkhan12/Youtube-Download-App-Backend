...
var comparePassword = function (candidatePassword, hashedPassword) { return __awaiter(void 0, void 0, void 0, function () {
    var isMatch;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bcrypt_1.default.compare(candidatePassword, hashedPassword)];
            case 1:
                isMatch = _a.sent();
